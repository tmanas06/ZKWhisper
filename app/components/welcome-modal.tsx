  ...
  return (
    <div className={'modal-overlay'}>
      <div className={'modal'}>
        ...
        <h2 className={'modal-title'}>Welcome to ZKWhisper!</h2>
        <div className={'modal-content'}>
          <p>
            ZKWhisper is a platform to anonymously post messages while proving you belong to an organization -
          ...
          <p>
            ...
            <a href="https://github.com/tmanas06/zkwhisper" target="_blank" rel="noopener noreferrer">here</a>.
          </p>
        </div>
      </div>
    </div>
