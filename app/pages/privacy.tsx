...
export default function PrivacyPolicyPage() {
    return (
        <>
            <Head>
                <title>Privacy Policy - ZKWhisper</title>
            </Head>
            ...
            <div className="article">
                ...
                <div className="mt-3">
                    <h3>Introduction</h3>
                    <p>
                        At ZKWhisper, we are committed to protecting your privacy and ensuring the security 
                        of your communications. This privacy policy explains how we handle your data.
                    </p>

                    <h3>Data Collection and Storage</h3>
                    <p>
                        ZKWhisper is designed with privacy at its core. Our server:
                    </p>
                    <ul>
                    ...
                    <p>
                        Internal messages in ZKWhisper are not encrypted. They are only hidden from the public field.
                        ZKWhisper server has access to all internal messages.
                        <br />
                    ...
                    <p>
                        ...
                        please reach out to us on <a href="https://github.com/tmanas06/zkwhisper">GitHub</a>.
                    </p>
                </div>
            </div>
        </>
