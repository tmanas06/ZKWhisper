...
echo "Gate count:"
bb gates -b target/zkwhisper_jwt.json | jq  '.functions[0].circuit_size'

# Create version-specific directory
mkdir -p "../app/assets/jwt"

echo "Copying circuit.json to app/assets/jwt..."
cp target/zkwhisper_jwt.json "../app/assets/jwt/circuit.json"

echo "Generating vkey..."
bb write_vk -b ./target/zkwhisper_jwt.json -o ./target
